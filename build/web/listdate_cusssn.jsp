                ...
                <div class="container">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <%
                                String query = "(SELECT SSN, ProfileID, Profile1, CustRep, Date_Time, Location, BookingFee, Comments, User1Rating, User2Rating FROM personprofiledates WHERE ProfileID=Profile2 AND SSN='" + ssn + "') UNION (SELECT SSN, ProfileID, Profile2, CustRep, Date_Time, Location, BookingFee, Comments, User1Rating, User2Rating FROM personprofiledates WHERE ProfileID=Profile1 AND SSN='" + ssn + "');";
