<%-- 
    Document   : customer_revenue
    Created on : Nov 30, 2014, 1:53:30 PM
    Author     : Jessica
--%>
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <h1 class="page-header">
                    <%
                        ...
                        out.print("Revenue Generated by Dates Involving " + customerSSN);
                    %>
                </h1>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <%
                                ...
                                String Query = "SELECT SSN, SUM(BookingFee) FROM PersonProfileDates P WHERE '" + customerSSN + "' = SSN GROUP BY SSN;";
